...
var vara = new Vara(
  ...
  [
    {
      text: "Start your registry today!",
...
vara.ready(function() {
  ...
  vara.animationEnd(function(i, o) {
    ...
    if (erase) {
      o.containerr.style.transition = "opacity 1s 1s";
      o.containerr.style.opacity = 1;
    }
  });
  vara.get("github").containerr.style.cursor = "pointer";
  vara.get("github").containerr.onclick = function() {
